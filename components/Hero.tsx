...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[100svh] md:min-h-screen flex flex-col pt-16 md:pt-0 overflow-hidden bg-black">
      ...
      {/* Background Image - Adjusted proportions for Desktop */}
      <div className="absolute top-0 right-0 w-full lg:w-[55%] h-full z-0 pointer-events-none overflow-hidden">
        <div className="relative w-full h-full">
          <img 
            ...
            alt="Dr. Thiago Costa" 
            className="w-full h-full object-cover opacity-65 lg:opacity-85 scale-110 lg:scale-110 object-top md:object-center grayscale brightness-[1.2] contrast-[1.1] lg:translate-x-10"
          />
