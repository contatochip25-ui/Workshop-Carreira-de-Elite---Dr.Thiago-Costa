    ...
    <section className="py-24 md:py-40 px-6 bg-[#000000] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24 relative z-10">
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          <h2 className="font-serif text-4xl md:text-5xl mb-12 leading-[1.2] text-white reveal opacity-0 translate-y-10 transition-all duration-700 relative md:pl-8 md:border-l-4 border-[#F4C542]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-14 text-left">
            <div className="reveal opacity-0 translate-y-10 transition-all duration-700 premium-card p-7 md:p-8 rounded-2xl">
              <h3 className="gold-text font-serif text-2xl mb-4 font-bold uppercase tracking-wide">Radar de Confiabilidade</h3>
            ...
            <div className="reveal opacity-0 translate-y-10 transition-all duration-700 delay-150 premium-card p-7 md:p-8 rounded-2xl">
              <h3 className="gold-text font-serif text-2xl mb-4 font-bold uppercase tracking-wide">Estratégia Relacional</h3>
              <p className="text-zinc-400 text-base leading-relaxed font-light">
          ...
          <p className="mt-14 text-zinc-300 font-light leading-relaxed reveal opacity-0 translate-y-10 transition-all duration-700 text-xl italic">
        ...
        <div className="w-full lg:w-2/5 reveal opacity-0 translate-x-[20px] transition-all duration-1000">
           <div className="relative group rounded-2xl overflow-hidden border border-zinc-800 aspect-[4/5] shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/60 backdrop-blur-md rounded-xl border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <p className="text-[11px] gold-text uppercase tracking-widest font-black">Liderança & Autoridade</p>
              </div>
           </div>
        </div>
      </div>
