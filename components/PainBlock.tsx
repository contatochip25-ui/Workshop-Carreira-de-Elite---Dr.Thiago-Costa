    ...
    <section className="py-20 md:py-32 bg-[#050505] px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center space-x-4 mb-8 md:mb-10 reveal opacity-0 translate-y-10 transition-all duration-700">
           ...
           <span className="font-serif italic text-lg md:text-2xl text-zinc-500">O Confronto</span>
           <div className="h-px flex-1 bg-zinc-900"></div>
        </div>

        <h2 className="font-serif text-2xl md:text-5xl text-center mb-10 md:mb-20 leading-tight text-white reveal opacity-0 translate-y-10 transition-all duration-700 relative pb-6 md:pb-8 after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-16 after:h-0.5 after:bg-gradient-to-r after:from-transparent after:via-[#F4C542] after:to-transparent">
          ...
          {pains.map((pain, idx) => (
            ...
            >
              <div className="mt-1 shrink-0">
                <AlertCircle className="w-4 h-4 md:w-6 md:h-6 text-zinc-600 group-hover:gold-text transition-colors duration-500" />
              </div>
              <p className="text-sm md:text-xl text-zinc-300 font-light leading-relaxed group-hover:text-zinc-100 transition-colors">
                {pain}
              </p>
            </div>
          ))}
        ...
        <div className="mt-12 md:mt-24 p-6 md:p-12 border border-zinc-900 bg-zinc-900/10 rounded-xl md:rounded-2xl text-center reveal opacity-0 translate-y-10 transition-all duration-700">
           <p className="text-zinc-400 italic text-sm md:text-lg px-2 md:px-4 leading-relaxed font-light">
