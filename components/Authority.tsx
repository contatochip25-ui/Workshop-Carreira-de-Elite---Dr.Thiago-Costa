        ...
        <div className="w-full md:w-[45%] reveal opacity-0 translate-x-[-20px] transition-all duration-1000">
          <div className="relative group">
            ...
            <div className="absolute bottom-10 left-10 bg-black/90 backdrop-blur-md p-6 border-l-4 border-[#F4C542] shadow-2xl">
                <p className="font-serif text-3xl text-[#F4C542] font-bold">Dr. Thiago Costa</p>
                <p className="text-sm text-zinc-100 uppercase tracking-widest mt-1 font-bold">Mentor de Carreira Médica</p>
            </div>
          </div>
        </div>
        
        <div className="w-full md:w-[55%] reveal opacity-0 translate-x-[20px] transition-all duration-1000">
          <span className="text-sm md:text-sm uppercase tracking-[0.4em] text-zinc-300 mb-8 block font-black">A Experiência nas Trincheiras</span>
          <h2 className="font-serif text-5xl md:text-6xl mb-12 md:mb-14 leading-tight text-white relative pl-6 border-l-4 border-[#F4C542]">
            Quem conhece o <span className="gold-text">jogo de dentro</span> não depende da sorte.
          </h2>
          
          <div className="space-y-10 text-zinc-200 text-xl md:text-xl leading-relaxed font-light max-w-2xl">
            <p>
          ...
          <div className="mt-16 md:mt-20 flex flex-wrap gap-5">
             <div className="px-6 py-3 bg-zinc-900 border border-zinc-700 text-sm md:text-sm text-white rounded-full tracking-wider font-bold">Estratégia de Escala</div>
             <div className="px-6 py-3 bg-zinc-900 border border-zinc-700 text-sm md:text-sm text-white rounded-full tracking-wider font-bold">Leitura de Ambiente</div>
             <div className="px-6 py-3 bg-zinc-900 border border-zinc-700 text-sm md:text-sm text-white rounded-full tracking-wider font-bold">Posicionamento Real</div>
          </div>
        </div>
      </div>
    </section>
