  ...
  return (
    <section className="py-24 md:py-56 px-6 bg-[#030303] text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <p className="text-zinc-400 text-sm md:text-xl mb-16 md:mb-20 max-w-2xl mx-auto px-2 reveal opacity-0 translate-y-10 transition-all duration-700 delay-100 font-light leading-relaxed">
        ...
        <div className="reveal opacity-0 translate-y-10 transition-all duration-700 delay-200 mb-12 flex flex-col items-center w-full">
            ...
            <span className="text-zinc-600 line-through text-xl md:text-2xl font-light tracking-widest mb-4 opacity-50">De R$ 997</span>
            
            <div className="flex flex-col items-center mb-12 w-full overflow-hidden">
                <span className="gold-text text-[10px] md:text-sm uppercase tracking-[0.4em] font-black mb-4">Por apenas</span>
            ...
            <p className="text-zinc-500 text-[9px] md:text-[11px] uppercase tracking-[0.2em] mt-6 font-medium opacity-60">
        ...
        <div className="mt-16 md:mt-32 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 max-w-4xl mx-auto reveal opacity-0 translate-y-10 transition-all duration-700 delay-300">
          <div className="flex items-center space-x-3 text-zinc-400 group">
            ...
            <span className="text-[9px] md:text-xs uppercase tracking-[0.2em] font-bold">Pagamento Seguro</span>
          </div>
          <div className="flex items-center space-x-3 text-zinc-400 group">
            <Mail className="w-5 h-5 gold-text group-hover:scale-110 transition-transform" />
            <span className="text-[9px] md:text-xs uppercase tracking-[0.2em] font-bold">Acesso Imediato</span>
          </div>
          <div className="flex items-center space-x-3 text-zinc-400 group">
            <Headphones className="w-5 h-5 gold-text group-hover:scale-110 transition-transform" />
            <span className="text-[9px] md:text-xs uppercase tracking-[0.2em] font-bold">Suporte Especializado</span>
          </div>
        </div>
      </div>
    </section>
