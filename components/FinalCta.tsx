      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="reveal opacity-0 translate-y-10 transition-all duration-700 delay-200 mb-12 flex flex-col items-center">
            ...
            <div className="flex flex-col items-center mb-10">
                ...
                <span className="text-white text-6xl md:text-[9rem] font-black leading-none tracking-tighter drop-shadow-[0_0_40px_rgba(244,197,66,0.2)]">
                  R$ 27,00
                </span>
            </div>
            
            {/* CTA Button - EXACT Replica of Hero button in proportions and styling */}
            ...
            {/* Progress Bar - EXACT Replica of Hero progress bar */}
