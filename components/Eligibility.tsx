    ...
    <section className="py-24 px-6 bg-[#0d0d0d]">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
        <div className="reveal opacity-0 translate-x-[-20px] transition-all duration-700">
          <h2 className="font-serif text-3xl mb-12 border-b border-zinc-700 pb-4 text-white font-bold">Este Workshop é para você se:</h2>
        ...
        <div className="reveal opacity-0 translate-x-[20px] transition-all duration-700">
          <h2 className="font-serif text-3xl mb-12 border-b border-zinc-700 pb-4 text-zinc-300 font-bold">NÃO é para você se:</h2>
          <ul className="space-y-6">
