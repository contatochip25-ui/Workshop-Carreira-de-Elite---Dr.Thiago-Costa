...
const WorkshopContent: React.FC = () => {
  ...
  return (
    <section className="py-24 md:py-40 px-6 bg-[#030303]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-24 md:mb-32">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto reveal opacity-0 translate-y-10 transition-all duration-700 delay-100 font-light italic">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((item, idx) => (
            <div 
              key={idx} 
              className="premium-card p-10 md:p-12 rounded-3xl group reveal opacity-0 translate-y-10"
              style={{ transitionDelay: `${idx * 100}ms` }}
            >
              <div className="mb-10 w-14 h-14 bg-zinc-900 flex items-center justify-center rounded-2xl group-hover:bg-[#F4C542]/10 transition-colors duration-500">
                {item.icon}
              </div>
              <h3 className="font-serif text-2xl md:text-3xl mb-6 text-white group-hover:gold-text transition-colors font-bold tracking-tight">
                {item.title}
              </h3>
          ...
          <div className="p-10 md:p-12 rounded-3xl border-2 border-dashed border-zinc-900 flex flex-col justify-center items-center text-center reveal opacity-0 translate-y-10 bg-transparent hover:border-[#F4C542]/20 transition-all duration-500">
            <p className="text-zinc-400 italic text-lg font-medium leading-relaxed">
